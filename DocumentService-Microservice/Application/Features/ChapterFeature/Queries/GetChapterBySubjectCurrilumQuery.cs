...
public class GetChapterBySubjectCurrilumQueryHandler : IRequestHandler<GetChapterBySubjectCurrilumQuery, PagedList<ChapterResponseModel>>
{
    private readonly IUnitOfWork _unitOfWork;
    private readonly IMapper _mapper;
    private readonly PaginationOptions _paginationOptions;
    private readonly ILogger<GetChapterBySubjectCurrilumQueryHandler> _logger;
    private readonly IProducerService _producerService;
    private readonly IClaimInterface _claimService;
    
    public GetChapterBySubjectCurrilumQueryHandler(IUnitOfWork unitOfWork, IMapper mapper, IOptions<PaginationOptions> paginationOptions,
        IProducerService producerService, IClaimInterface claimService, ILogger<GetChapterBySubjectCurrilumQueryHandler> logger)
    {
