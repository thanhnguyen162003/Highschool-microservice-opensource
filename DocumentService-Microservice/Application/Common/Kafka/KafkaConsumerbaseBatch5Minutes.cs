...
{
	public abstract class KafkaConsumerbaseBatch5Minutes<T> : BackgroundService
	{
		private readonly IConsumer<string, string> _consumer;
		private readonly IServiceProvider _serviceProvider;
		private readonly ILogger<KafkaConsumerbaseBatch5Minutes<T>> _logger;
		...
		protected KafkaConsumerbaseBatch5Minutes(IConfiguration configuration, ILogger<KafkaConsumerbaseBatch5Minutes<T>> logger,
