...
public static class ResponseConstaints
{
    ...
    #region Category
    public const string CategoryCreated = "Tạo danh mục thành công";
    public const string CategoryCreateFailed = "Tạo danh mục thất bại";
    public const string CategoryDeleted = "Xóa danh mục thành công";
    public const string CategoryDeleteFailed = "Xóa danh mục thất bại";
    public const string CategoryUpdated = "Cập nhật danh mục thành công";
    public const string CategoryUpdateFailed = "Cập nhật danh mục thất bại";
    #endregion
