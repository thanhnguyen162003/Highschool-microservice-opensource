...
public class ConsumerUpdateNewViewService : KafkaConsumerNewsViewMethod
{
    private readonly ILogger<ConsumerUpdateNewViewService> _logger;
    private readonly IProducerService _producerService;
    private readonly IServiceProvider _serviceProvider;
    private readonly IMapper _mapper;
    public ConsumerUpdateNewViewService (IConfiguration configuration, ILogger<ConsumerUpdateNewViewService> logger, IServiceProvider serviceProvider)
        : base(configuration, logger, serviceProvider, KafkaConstaints.NewViewUpdate, "new_view_consumer_group")
    {
    }
