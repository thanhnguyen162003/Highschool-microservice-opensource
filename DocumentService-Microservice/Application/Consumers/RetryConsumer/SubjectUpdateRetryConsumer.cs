...
public class SubjectUpdateRetryConsumer : KafkaConsumerBase5Minutes<SubjectUpdateConsumeModel>
{
    public SubjectUpdateRetryConsumer(IConfiguration configuration, ILogger<SubjectUpdateRetryConsumer> logger, IServiceProvider serviceProvider)
        : base(configuration, logger, serviceProvider, TopicKafkaConstaints.SubjectImageUpdatedRetry, "subject_update_image_document_consumer_group")
    {
    }
