...
namespace Application.Features.UserQuizProgressFeature.Queries
{
    ...
    public class UserHasQuizProgressQueryHandler : IRequestHandler<UserHasQuizProgressQuery, ResponseModel>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;
        private readonly IClaimInterface _claimInterface;

        public UserHasQuizProgressQueryHandler(IUnitOfWork unitOfWork, IMapper mapper, IClaimInterface claimInterface)
        {
