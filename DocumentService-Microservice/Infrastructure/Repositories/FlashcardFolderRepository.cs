...
{
    public class FlashcardFolderRepository : BaseRepository<FlashcardFolder>, IFlashcardFolderRepository
    {
        public FlashcardFolderRepository(DocumentDbContext context) : base(context)
        {
        }
