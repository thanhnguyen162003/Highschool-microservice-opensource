...
namespace Application.Features.QuestionFeature.Queries
{
    ...
    public class QuestionAdvanceQueryHandler : IRequestHandler<QuestionAdvanceQuery, PagedList<QuestionResponseModel>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

        public QuestionAdvanceQueryHandler(IUnitOfWork unitOfWork, IMapper mapper)
        {
