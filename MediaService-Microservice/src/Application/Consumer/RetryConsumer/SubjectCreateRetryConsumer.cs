...
public class SubjectCreateRetryConsumer : KafkaConsumerBase5Minutes<SubjectImageCreateModel>
{
    public SubjectCreateRetryConsumer(IConfiguration configuration, ILogger<SubjectCreateRetryConsumer> logger, IServiceProvider serviceProvider)
        : base(configuration, logger, serviceProvider, KafkaConstaints.SubjectImageCreatedRetry, "subject_update_consumer_group")
    {
    }
