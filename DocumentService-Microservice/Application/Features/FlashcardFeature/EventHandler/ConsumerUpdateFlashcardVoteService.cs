...
public class ConsumerUpdateFlashcardVoteService : KafkaConsumerFlashcardVoteMethod
{
    ...
    public ConsumerUpdateFlashcardVoteService(IConfiguration configuration, ILogger<ConsumerUpdateFlashcardVoteService> logger, IServiceProvider serviceProvider)
        : base(configuration, logger, serviceProvider, TopicKafkaConstaints.FlashcardVoteUpdate, "flashcard_vote_consumer_group")
    {
    }
