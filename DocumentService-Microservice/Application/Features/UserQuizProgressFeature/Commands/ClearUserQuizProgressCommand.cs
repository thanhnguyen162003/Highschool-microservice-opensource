...
namespace Application.Features.UserQuizProgressFeature.Commands
{
    ...
    public class ClearUserQuizProgressCommandHandler : IRequestHandler<ClearUserQuizProgressCommand, ResponseModel>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IClaimInterface _claimInterface;

        public ClearUserQuizProgressCommandHandler(IUnitOfWork unitOfWork, IClaimInterface claimInterface)
        {
