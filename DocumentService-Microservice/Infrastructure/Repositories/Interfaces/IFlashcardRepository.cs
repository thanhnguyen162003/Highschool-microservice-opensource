...
public interface IFlashcardRepository : IRepository<Flashcard>
{
    ...
    Task<IEnumerable<string>> GetFlashcardBySubjectId(IEnumerable<string> subjectIds, CancellationToken cancellationToken = default);
    Task<IEnumerable<Flashcard>> GetFlashcardForTips(IEnumerable<string> flashcardIds, CancellationToken cancellationToken = default);
