...
public class ProcessOutboxMessagesJob : IJob
{
    ...
    public ProcessOutboxMessagesJob(AnalyseDbContext dbContext, ILogger<ProcessOutboxMessagesJob> logger, IKafkaConsumerMethod consumerMethod, IProducerService producerService)
    {
