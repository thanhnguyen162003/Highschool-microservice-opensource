...
namespace Application.Endpoints
{
    public class FolderEndpoint : ICarterModule
    {
        public void AddRoutes(IEndpointRouteBuilder app)
        {
            ...
            group.MapGet("", GetFolderUser).RequireAuthorization().WithName(nameof(GetFolderUser));
            group.MapGet("flashcards", GetFlashcardOnFolder).RequireAuthorization().WithName(nameof(GetFlashcardOnFolder));
