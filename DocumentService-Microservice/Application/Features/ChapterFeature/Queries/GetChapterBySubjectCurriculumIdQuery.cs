...
public class GetChapterBySubjectCurriculumIdQueryHandler : IRequestHandler<GetChapterBySubjectCurriculumIdQuery, PagedList<ChapterResponseModel>>
{
    private readonly IUnitOfWork _unitOfWork;
    private readonly IMapper _mapper;
    private readonly PaginationOptions _paginationOptions;
    private readonly ILogger<GetChapterBySubjectCurriculumIdQueryHandler> _logger;
    private readonly IProducerService _producerService;
    private readonly IClaimInterface _claimService;
    
    public GetChapterBySubjectCurriculumIdQueryHandler(IUnitOfWork unitOfWork, IMapper mapper, IOptions<PaginationOptions> paginationOptions,
        IProducerService producerService, IClaimInterface claimService, ILogger<GetChapterBySubjectCurriculumIdQueryHandler> logger)
    {
