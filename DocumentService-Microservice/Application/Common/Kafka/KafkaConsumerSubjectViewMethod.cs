...
public abstract class KafkaConsumerSubjectViewMethod : BackgroundService
{
    private readonly IConsumer<string, string> _consumer;
    private readonly ILogger<KafkaConsumerSubjectViewMethod> _logger;
    private readonly IServiceProvider _serviceProvider;
    private readonly string _topicName;
    public KafkaConsumerSubjectViewMethod(IConfiguration configuration, ILogger<KafkaConsumerSubjectViewMethod> logger,
