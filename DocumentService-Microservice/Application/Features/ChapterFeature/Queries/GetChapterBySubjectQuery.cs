...
public class GetChapterBySubjectQueryHandler(IUnitOfWork unitOfWork, IMapper mapper, IOptions<PaginationOptions> paginationOptions,
    IProducerService producerService, IClaimInterface claimService, ILogger<GetChapterBySubjectQueryHandler> logger) : IRequestHandler<GetChapterBySubjectQuery, PagedList<ChapterResponseModel>>
{
    private readonly IUnitOfWork _unitOfWork = unitOfWork;
    private readonly IMapper _mapper = mapper;
    private readonly PaginationOptions _paginationOptions;
    private readonly ILogger<GetChapterBySubjectQueryHandler> _logger = logger;
