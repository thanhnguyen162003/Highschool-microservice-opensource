...
public class LessonVideoConsumer : KafkaConsumerBase<KafkaVideoLessonUploadedModel>
{
    public LessonVideoConsumer(IConfiguration configuration, ILogger<LessonVideoConsumer> logger, IServiceProvider serviceProvider)
        : base(configuration, logger, serviceProvider, TopicKafkaConstaints.VideoUploaded, "lesson_video_uploaded_consumer_group")
    {
    }
