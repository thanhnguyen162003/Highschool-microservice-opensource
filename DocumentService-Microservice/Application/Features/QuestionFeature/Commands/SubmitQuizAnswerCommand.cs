...
namespace Application.Features.QuestionFeature.Commands
{
    ...
    public class SubmitQuizAnswerCommandHandler : IRequestHandler<SubmitQuizAnswerCommand, ResponseModel>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IClaimInterface _claimInterface;
        private readonly IMapper _mapper;

        public SubmitQuizAnswerCommandHandler(IUnitOfWork unitOfWork, IClaimInterface claimInterface, IMapper mapper)
        {
