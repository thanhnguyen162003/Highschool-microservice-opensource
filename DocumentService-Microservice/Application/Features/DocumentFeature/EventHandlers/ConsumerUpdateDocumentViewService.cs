...
public class ConsumerUpdateDocumentViewService : KafkaConsumerDocumentViewMethod
{
    ...
    public ConsumerUpdateDocumentViewService(IConfiguration configuration, ILogger<ConsumerUpdateDocumentViewService> logger, IServiceProvider serviceProvider)
        : base(configuration, logger, serviceProvider, TopicKafkaConstaints.DocumentViewUpdate, "document_view_consumer_group")
    {
    }
