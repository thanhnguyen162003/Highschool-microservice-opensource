...
public class LessonVideoRetryConsumer : KafkaConsumerBase5Minutes<KafkaVideoLessonUploadedModel>
{
    public LessonVideoRetryConsumer(IConfiguration configuration, ILogger<LessonVideoRetryConsumer> logger, IServiceProvider serviceProvider)
        : base(configuration, logger, serviceProvider, TopicKafkaConstaints.VideoUploadedRetry, "lesson_video_uploaded_consumer_group")
    {
    }
