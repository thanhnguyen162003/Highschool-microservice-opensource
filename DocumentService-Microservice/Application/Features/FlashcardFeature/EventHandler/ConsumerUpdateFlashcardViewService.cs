...
public class ConsumerUpdateFlashcardViewService : KafkaConsumerFlashcardViewMethod
{
    ...
    public ConsumerUpdateFlashcardViewService(IConfiguration configuration, ILogger<ConsumerUpdateFlashcardViewService> logger, IServiceProvider serviceProvider)
        : base(configuration, logger, serviceProvider, TopicKafkaConstaints.FlashcardViewUpdate, "flashcard_view_consumer_group")
    {
    }
