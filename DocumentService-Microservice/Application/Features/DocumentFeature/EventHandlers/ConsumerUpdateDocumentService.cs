...
public class ConsumerUpdateDocumentService : KafkaConsumerBase<DocumentUpdateConsumeModel>
{
    public ConsumerUpdateDocumentService(IConfiguration configuration, ILogger<ConsumerUpdateDocumentService> logger, IServiceProvider serviceProvider)
        : base(configuration, logger, serviceProvider, TopicKafkaConstaints.DocumentFileUpdated, "document_file_consumer_group")
    {
    }
