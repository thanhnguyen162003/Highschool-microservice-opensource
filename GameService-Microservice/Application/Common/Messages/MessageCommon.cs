namespace Application.Messages
{
    public class MessageCommon
    {
        ...
        public const string UpdateRedisFailed = "Update Redis Failed";
        public const string UpdateElasticFailed = "Update Elastic Failed";
        public const string CreateSuccesfully = "Create Successfully";
        public const string CreateFailed = "Create Failed";

        public const string SomethingErrors = "Something have wrong!";
