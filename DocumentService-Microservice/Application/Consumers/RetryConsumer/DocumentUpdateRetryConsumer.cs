...
public class DocumentUpdateRetryConsumer : KafkaConsumerBase5Minutes<DocumentUpdateConsumeModel>
{
    public DocumentUpdateRetryConsumer(IConfiguration configuration, ILogger<DocumentUpdateRetryConsumer> logger, IServiceProvider serviceProvider)
        : base(configuration, logger, serviceProvider, TopicKafkaConstaints.DocumentFileUpdatedRetry, "document_file_consumer_group")
    {
    }
