...
namespace Application.Features.QuestionFeature.Queries
{
    ...
    public class GetQuizQueryHandler : IRequestHandler<GetQuizQuery, ResponseModel>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;
        private readonly IClaimInterface _claimInterface;

        public GetQuizQueryHandler(IUnitOfWork unitOfWork, IMapper mapper, IClaimInterface claimInterface)
        {
