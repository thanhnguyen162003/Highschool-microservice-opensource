...
public abstract class KafkaConsumerDocumentViewMethod : BackgroundService
{
    private readonly IConsumer<string, string> _consumer;
    private readonly ILogger<KafkaConsumerDocumentViewMethod> _logger;
    private readonly IServiceProvider _serviceProvider;
    private readonly string _topicName;
    public KafkaConsumerDocumentViewMethod(IConfiguration configuration, ILogger<KafkaConsumerDocumentViewMethod> logger,
