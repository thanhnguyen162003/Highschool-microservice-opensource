...
public class ConsumerUpdateSubjectService : KafkaConsumerBase<SubjectUpdateConsumeModel>
{
    public ConsumerUpdateSubjectService(IConfiguration configuration, ILogger<ConsumerUpdateSubjectService> logger, IServiceProvider serviceProvider)
        : base(configuration, logger, serviceProvider, TopicKafkaConstaints.SubjectImageUpdated, "subject_update_image_document_consumer_group")
    {
    }
