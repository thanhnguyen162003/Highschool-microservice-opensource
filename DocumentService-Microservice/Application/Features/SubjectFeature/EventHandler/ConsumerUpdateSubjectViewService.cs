...
public class ConsumerUpdateSubjectViewService : KafkaConsumerSubjectViewMethod
{
    ...
    public ConsumerUpdateSubjectViewService (IConfiguration configuration, ILogger<ConsumerUpdateSubjectViewService> logger, IServiceProvider serviceProvider)
        : base(configuration, logger, serviceProvider, TopicKafkaConstaints.SubjectViewUpdate, "subject_view_consumer_group")
    {
    }
