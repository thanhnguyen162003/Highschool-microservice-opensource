...
{
    public class CreateDocumentCommand : IRequest<ResponseModel>
    {
        public CreateDocumentRequestModel CreateDocumentRequestModel;
    }
    public class CreateDocumentCommandHandler(IUnitOfWork unitOfWork, IMapper mapper, IClaimInterface claim) : IRequestHandler<CreateDocumentCommand, ResponseModel>
    {
